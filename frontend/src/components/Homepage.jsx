  ...
  return (
    <div id='/about' className='md:w-full h-full ' >
      <div className='flex m-[17vh] pt-20 '>
        <div className='md:max-w-[1000px] w-[1600px] md:h-[40vh] flex flex-col p-4 gap-10 'data-aos="fade-right" data-aos-anchor-placement="top-center" data-aos-mirror="true" data-aos-duration="3000">
        ...
        <div className='w-full' data-aos="fade-left" data-aos-anchor-placement="top-center" data-aos-mirror="true" data-aos-duration="3000">
        <Image
        src="/main.png"
        alt=""
        width={900}
        ...
        <div className=' h-[20vh] w-full' data-aos="flip-left"   data-aos-duration="1000">
